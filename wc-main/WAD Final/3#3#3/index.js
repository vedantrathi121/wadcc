function generate() {
    ...
    table = document.getElementById("3");
    colorProperty = {}
    colorList = [
        ...
        if (v1 == v2) {
            ...
            for (let i = 0; i < r2; i++) {
                ...
                for (let j = 0; j < c2; j++) {
                    ...
                    val = (v2 + m) * n;
                    data.innerHTML = val;
                    if(colorProperty[val]){
                        data.style.backgroundColor = colorProperty[val];
                    }else{
                        data.style.backgroundColor = colorList[colorIndex];
                        colorProperty[val] =  colorList[colorIndex];
                        colorIndex++;
                    }
                    m++;
                    row.appendChild(data);
            ...
            for (let i = 0; i < r2; i++) {
                ...
                for (let j = 0; j < c2; j++) {
                    ...
                    if(colorProperty[val1 * val2]){
                        data.style.backgroundColor = colorProperty[val1 * val2];
                    }else{
                        data.style.backgroundColor = colorList[colorIndex];
                        colorProperty[val1 * val2] =  colorList[colorIndex];
                        colorIndex++;
                    }
                    m++;
                    row.appendChild(data);
